            ...
            <div class="col-md-6 mx-auto shadow-lg p-3 mb-5 bg-body rounded">
                <form action="{{route('personnel.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" class="form-control" id="nm" name="nom" value="{{$perso->nom}}">
                      </div>
                      <div class="my-3">
                        <label for="pr" class="form-label text-capitalize">prenom</label>
                        <input type="text" class="form-control" id="pr" name="prenom" value="{{$perso->prenom}}">
                      </div>
                      <div class="my-3">
                        <label for="em" class="form-label text-capitalize">email</label>
                        <input type="email" class="form-control" id="em" name="email" value="{{$perso->email}}">
                      </div>
                      <div class="my-3">
                        <label for="tl" class="form-label text-capitalize">specialite</label>
                        <input type="text" class="form-control" id="nv" name="specialite" value="{{$perso->specialite}}">
                      </div>
                      <div class="my-3">
                        <label for="ad" class="form-label text-capitalize">adresse</label>
                        <textarea name="adresse" id="ad" cols="30" class="form-control" >{{$perso->adresse}}</textarea>
                      </div>
                      <div class="my-3">
                        <label for="nv" class="form-label text-capitalize">telephone</label>
                        <input type="text" class="form-control" id="tl" name="tel" value="{{$perso->tel}}">
                      </div>
                      <div class="my-3">
